...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "RuRfoSHKvlz1rgLZVABzgQL6y", consumerSecret: "Fr1OlKvuH7GbX05AmbgfcwfTD30P6Uf0X85yOIFi02KWQ1tU0o")
    var loginSuccess: (() -> ())?
